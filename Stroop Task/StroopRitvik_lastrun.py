...
expName = 'StroopRitvik'  # from the Builder filename that created this script
expInfo = {
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='D:\\Neuroscience Games\\Stroop Game\\StroopRitvik_lastrun.py',
...
trials = data.TrialHandler(nReps=4.0, method='random', 
    ...
    trialList=data.importConditions('stroopParameters.xlsx'),
