...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='D:\\Neuroscience Games\\Go-Nogo Task\\go_nogo_lastrun.py',
...
text_2 = visual.TextStim(win=win, name='text_2',
    text='With you dominant hand only, press the space bar when you see the green rectangle\n\n(Press any key to start)',
    font='Open Sans',
...
trials = data.TrialHandler(nReps=10.0, method='random', 
    ...
    trialList=data.importConditions('go_nogo.xlsx'),
...
for thisTrial in trials:
    ...
    # keep track of which components have finished
    trialComponents = [key_resp, image_2]
